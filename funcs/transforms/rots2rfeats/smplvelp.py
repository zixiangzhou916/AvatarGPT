...
# from temos.tools.easyconvert import matrix_to, nfeats_of, to_matrix
from funcs.easyconvert import matrix_to, nfeats_of, to_matrix
# import temos.tools.geometry as geometry
import funcs.geometry as geometry
...
class SMPLVelP(Rots2Rfeats):
    ...
    def inverse(self, features):
        ...
        from funcs.transforms.smpl import RotTransDatastruct
